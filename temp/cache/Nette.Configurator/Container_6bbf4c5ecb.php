...
class Container_6bbf4c5ecb extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function createServiceConsole__application()
	{
		...
		$service->add($this->getService('translation.console.extract'));
		return $service;
	}
	...
	{
		return new Container_6bbf4c5ecb_Kdyby_Doctrine_EntityDaoFactoryImpl_doctrine_daoFactory($this);
	}
	...
	{
		return new Container_6bbf4c5ecb_Kdyby_Doctrine_DI_IRepositoryFactoryImpl_doctrine_repositoryFactory_default_defaultRepositoryFactory($this);
	}
	...
	{
		return new Container_6bbf4c5ecb_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_6bbf4c5ecb_Kdyby_Doctrine_EntityDaoFactoryImpl_doctrine_daoFactory implements Kdyby\Doctrine\EntityDaoFactory
{
	private $container;


	public function __construct(Container_6bbf4c5ecb $container)
	{
...
class Container_6bbf4c5ecb_Kdyby_Doctrine_DI_IRepositoryFactoryImpl_doctrine_repositoryFactory_default_defaultRepositoryFactory implements Kdyby\Doctrine\DI\IRepositoryFactory
{
	private $container;
...
class Container_6bbf4c5ecb_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;
